        ...
        <el-col >
          ...
          <el-form :model="newsDetail" label-width="100px">
            <el-form-item label="是否开启" prop="counts">
              <el-radio class="radio" v-model="newsDetail.delFlag" label="3">否</el-radio>
              <el-radio class="radio" v-model="newsDetail.delFlag" label="0">是</el-radio>
            </el-form-item>
          </el-form>
        </el-col>
      </el-row>
...
//      },
      submit(){
        ...
        if(this.array_pics.length<1){
          this.$message.error("请添加图片");
          return false;
        }
        if(this.newsDetail.bannerContent==''){
          this.$message.error("详情不能为空");
          return false;
        }
        this.$fetch.api_products.banneresave({
