<template>
  <div>
    <div class="classWrapper">
      ...
      <router-link :to="{name: '名流课堂添加', params: {id: 'add'}}" tag="span">
    ...
    <el-table :data="newsData"
      ...
      <el-table-column  label="推荐商道首页" align="center" >
        <template scope="scope">
      ...
      <el-table-column  label="推荐商学院" align="center" >
        <template scope="scope">
      ...
      <el-table-column label="操作" width="180">
        <template scope="props">
          <router-link :to="{name: '名流课堂添加', params: {id: props.row.id}}" tag="span">
