        ...
        <el-col >
          ...
          <el-form  :model="newsDetail" label-width="100px" >
            <el-form-item label="图片样式" >
              <el-radio class="radio" v-model="newsDetail.classify" label="0">图片</el-radio>
              <el-radio class="radio" v-model="newsDetail.classify" label="2">视频</el-radio>
            </el-form-item>
          </el-form>
          <!--<el-form ref="newsDetail" :model="newsDetail" label-width="100px" >-->
          ...
          <!--</el-form-item>-->
          <!--</el-form>-->
          <el-form :model="newsDetail" label-width="100px" v-show="newsDetail.classify!=2">
            <el-form-item label="修改图片" prop="counts">
              <!--<picsUpload></picsUpload>-->
              <picsUpload :defaultImgs="array_pics" :maxPostImgs="3"></picsUpload>
            </el-form-item>
          </el-form>

          <el-form ref="newsDetail" :model="newsDetail" label-width="100px" v-show="newsDetail.classify==2">
...
//        this.newsDetail.videoUrl=''
      ...
      submit(){
          ...
          if(this.newsDetail.classify==='2'){//视频
            if(this.videoUrl==''){
            ...
            if((this.array_pics).length==0){
              classify_submit=0
            }else if((this.array_pics).length==1){
              classify_submit=2
            }else if((this.array_pics).length==2) {
              this.$message.error("请上传一张或三张图片");
              return false;
            }else if((this.array_pics).length==3) {
              classify_submit=1
            }
            this.videoUrl ='';
          }
