<template>
  <div class="panel">
    <panel-title>
      ...
      <router-link :to="{name: '明星详情', params: {id: 'add'}}" tag="span">
        <el-button v-if="addBtn" type="primary" icon="plus" size="small" >添加明星</el-button>
      </router-link>
      ...
      <el-table :data="top10Data"
        ...
        <el-table-column label="操作" align="center" width="200">
          <template scope="props">
            <router-link :to="{name: '明星编辑详情', params: {id: props.row.id}}" tag="span">
