<template>
  <div>
    <el-table :data="newsData"
      ...
      <el-table-column prop="title" label="发布人" align="center" width="200"></el-table-column>
      <el-table-column  label="图片" align="center" width="200">
        <template scope="scope">
          <img width="80" height="80" :src="scope.row.pic.split(',')[0]">
        </template>
      </el-table-column>
      <el-table-column prop="typeName" label="发布内容" align="center" width="200"></el-table-column>
      <el-table-column prop="createDate" label="发布时间" width="200" align="center"></el-table-column>
      <el-table-column prop="celebrityName" label="显示状态" align="center"></el-table-column>
...
<script type="text/ecmascript-6">
  export default {
    ...
    methods: {
      getNews() {
        this.$fetch.api_business.getCommentList({
          moduleId: this.fun,
          userId: '',
