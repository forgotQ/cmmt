<template>
  <div class="panel">
    <panel-title>
      ...
      <router-link  :to="{name: '娱道banner', params: {id: 'add'}}" tag="span">
    ...
    <div class="panel-body">
      <el-table :data="bannerData"
        ...
        <el-table-column  label="banner位置" align="center" width="200">
          <template scope="scope">
            <span>{{scope.row.fun=="entertainment"?"娱道首页":"明星学院首页"}}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="180" align="center">
          <template scope="props">
            <router-link :to="{name: '娱道banner', params: {id: props.row.id}}" tag="span">
