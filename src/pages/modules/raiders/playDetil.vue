<template>
  <div class="panel">
    ...
    <div class="panel-body">
      <el-row>
        <el-col :span="8">
          <span style="margin-right: 10px">跟团游标题</span><el-input v-model="title" placeholder="请输入内容" style="width: 250px;"></el-input>
        </el-col>
        <el-col :span="8">
          <span style="margin-right: 10px">跟团游英文标题</span><el-input v-model="enTitle" placeholder="请输入内容" style="width: 250px;"></el-input>
        </el-col>
        <el-col :span="8">
