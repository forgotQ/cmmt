<template>
  <div class="panel">
    <panel-title>
      ...
      <router-link :to="{name: '景区详情', params: {id: 'add'}}" tag="span">
    ...
    <div class="panel-body">
      <el-table :data="bannerData"
        ...
        <el-table-column prop="sightseeingDuration" label="游玩时间"  align="center"></el-table-column>
        <el-table-column label="操作" width="180" align="center">
          <template scope="props">
            <router-link :to="{name: '景区详情', params: {id: props.row.id}}" tag="span">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      get_List_data(){
        this.load_data = true
        this.$fetch.api_raiders.getScenicsList({
      ...
      delete_data(item){
        this.$confirm('此操作将删除该数据, 是否继续?', '提示', {
          ...
          .then(() => {
            this.$fetch.api_raiders.scenicsDelete({
              id: item
            }).then((data) => {
